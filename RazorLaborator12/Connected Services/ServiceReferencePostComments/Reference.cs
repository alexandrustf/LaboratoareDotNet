...
namespace ServiceReferencePostComments
{
    ...
    public partial class Post : object
    {
        ...
        private System.Collections.Generic.List<ServiceReferencePostComments.Comment> CommentsField;
        ...
        public System.Collections.Generic.List<ServiceReferencePostComments.Comment> Comments
        {
            get
            {
    ...
    public partial class Comment : object
    {
        ...
        private ServiceReferencePostComments.Post PostField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public ServiceReferencePostComments.Post Post
        {
            get
            {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceReferencePostComments.IPostComment")]
    public interface IPostComment
    {
        ...
        System.Threading.Tasks.Task<bool> AddPostAsync(ServiceReferencePostComments.Post post);
        ...
        System.Threading.Tasks.Task<ServiceReferencePostComments.Post> UpdatePostAsync(ServiceReferencePostComments.Post post);
        ...
        System.Threading.Tasks.Task<ServiceReferencePostComments.Post> GetPostByIdAsync(int id);
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.List<ServiceReferencePostComments.Post>> GetPostsAsync();
        ...
        System.Threading.Tasks.Task<bool> AddCommentAsync(ServiceReferencePostComments.Comment comment);
        ...
        System.Threading.Tasks.Task<ServiceReferencePostComments.Comment> UpdateCommentAsync(ServiceReferencePostComments.Comment newComment);
        ...
        System.Threading.Tasks.Task<ServiceReferencePostComments.Comment> GetCommentByIdAsync(int id);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface IPostCommentChannel : ServiceReferencePostComments.IPostComment, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class PostCommentClient : System.ServiceModel.ClientBase<ServiceReferencePostComments.IPostComment>, ServiceReferencePostComments.IPostComment
    {
        ...
        public System.Threading.Tasks.Task<bool> AddPostAsync(ServiceReferencePostComments.Post post)
        {
            return base.Channel.AddPostAsync(post);
        }
        
        public System.Threading.Tasks.Task<ServiceReferencePostComments.Post> UpdatePostAsync(ServiceReferencePostComments.Post post)
        {
        ...
        public System.Threading.Tasks.Task<ServiceReferencePostComments.Post> GetPostByIdAsync(int id)
        {
            return base.Channel.GetPostByIdAsync(id);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<ServiceReferencePostComments.Post>> GetPostsAsync()
        {
        ...
        public System.Threading.Tasks.Task<ServiceReferencePostComments.Comment> GetCommentByIdAsync(int id)
        {
